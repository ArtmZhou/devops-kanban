    ...
    <div class="workspace-right">
      ...
      <div class="workspace-lower">
        <div class="workspace-lower-left">
          ...
          <div class="ai-split-card" :class="{ collapsed: !splitCardExpanded }">
            <div class="split-card-header" @click="splitCardExpanded = !splitCardExpanded">
              ...
              <div class="split-header-right">
                <span class="split-task-count">{{ splitSuggestions.length }} 个子任务</span>
                <span class="split-toggle" :class="{ open: splitCardExpanded }">
            ...
            <div class="split-card-body" v-show="splitCardExpanded">
              <div class="split-suggestions-list">
                <div
                  v-for="(suggestion, index) in splitSuggestions"
                  :key="index"
                  class="split-suggestion-item"
                >
                  <div class="suggestion-header">
                    <div class="suggestion-check">
                      <input type="checkbox" :checked="suggestion.enabled" @change="suggestion.enabled = !suggestion.enabled" />
                    </div>
                    <div class="suggestion-main">
                      <div class="suggestion-title">
                        {{ suggestion.title }}
                        <span class="suggestion-template-badge">{{ suggestion.template }}</span>
                      </div>
                  ...
                  <div class="suggestion-meta">
                    ...
                    <span class="meta-tag dep" v-if="suggestion.dependsOn && suggestion.dependsOn.length">
                      依赖: {{ suggestion.dependsOn.join(', ') }}
                    </span>
              ...
              <div class="split-footer">
                ...
                <div class="split-footer-actions">
                  <el-button size="small">取消</el-button>
                  <el-button size="small" type="primary">确认创建</el-button>
                </div>
              </div>
            </div>
          </div>
...
const splitSuggestions = [
  ...
  },
  {
    ...
    template: '测试模板',
    repo: 'git@github.com:org/integration-test.git',
    dependsOn: ['用户服务开发', '订单服务开发', '前端页面开发'],
    enabled: true
  }
]
...
const splitCardExpanded = ref(true) // AI split suggestion card expanded state
