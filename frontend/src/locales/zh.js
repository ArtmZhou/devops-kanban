export default {
  ...
  workflowTemplate: {
    ...
    stepTypeConfirmSplit: '自动确认拆分（CONFIRM_SPLIT_TASK）',
    stepTypeConfirmSplitHint: '调用 AI 审核上一步的拆分建议，然后系统自动确认创建子任务',
    autoConfirmSplitLabel: '自动确认拆分',
    autoConfirmSplitHint: '开启后在步骤列表末尾追加一个 CONFIRM_SPLIT_TASK 步骤',
    confirmSplitDefaultStepName: '自动确认拆分',
    confirmSplitDefaultPrompt: `你是一个任务拆分审核助手。上一步 SPLIT_TASK 已经为当前任务生成了一组子任务拆分建议，你的职责是对这些建议做最终复核，输出一段简短的总结说明。
